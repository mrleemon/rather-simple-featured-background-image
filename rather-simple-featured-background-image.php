...
class RatherSimpleFeaturedBackgroundImage {  
    ...
    */
    function background_image_meta_box_callback( $post ) {
        ...
        <p>
            <a href="#" id="fbi-set-image" class="<?php if ( !empty ( $fbi_image ) ) echo 'hide'; ?>"><?php _e( 'Set featured background image', 'rather-simple-featured-background-image' ); ?></a>
            <p id="fbi-image-desc" class="<?php if ( empty ( $fbi_image ) ) echo 'hide'; ?>"><?php _e( 'Click the image to edit or update' ); ?></p>
            <a href="#" id="fbi-remove-image"  class="<?php if ( empty ( $fbi_image ) ) echo 'hide'; ?>"><?php _e( 'Remove featured background image', 'rather-simple-featured-background-image' ); ?></a>
        </p>
    ...
    */
    function admin_enqueue_scripts() {
        ...
        //if( $typenow == 'post' || $typenow == 'page' ) {
            ...
            wp_localize_script( 'rather-simple-featured-background-image', 'meta_image',
                array(
...
add_action( 'plugins_loaded', array ( RatherSimpleFeaturedBackgroundImage::get_instance(), 'plugin_setup' ) );
